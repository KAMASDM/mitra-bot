...
import { EyeIcon, EyeSlashIcon, SparklesIcon, HeartIcon, UserGroupIcon } from '@heroicons/react/24/outline';
          ...
          <div className="hidden lg:block text-white space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-indigo-100">
                Your trusted companion for healthcare, employment, and community support
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all">
                ...
                <div>
                  <h3 className="font-semibold text-lg">Mental Health Support</h3>
                  <p className="text-indigo-100 text-sm">Connect with compassionate professionals</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all">
                ...
                <div>
                  ...
                  <p className="text-indigo-100 text-sm">Access healthcare and employment resources</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/20 transition-all">
                ...
                <div>
                  ...
                  <p className="text-indigo-100 text-sm">Join our inclusive LGBTQAI+ friendly community</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-10">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Sign in to continue to Gazra Mitra
                </p>
              </div>
